 ...
 */
#define NO_TEST_2P4G                                0x00  // 不测试2.4G

#define GEN_FSK_RX                                  0x10  // 通用FSK接收
#define GEN_FSK_SRX                                 0x11
#define GEN_FSK_SRX2TX                              0x12
#define GEN_FSK_STX                                 0x13
#define GEN_FSK_STX2RX                              0x14
#define GEN_FSK_TX                                  0x15  // 通用FSK发送

#define TPLL_PRX                                    0x20  // TPLL接收
#define TPLL_PTX                                    0x21  // TPLL发送

#define TPSLL_SRX                                   0x30
#define TPSLL_SRX2TX                                0x31
#define TPSLL_STX                                   0x32
#define TPSLL_STX2RX                                0x33  // TPSLL发送后接收（默认）
